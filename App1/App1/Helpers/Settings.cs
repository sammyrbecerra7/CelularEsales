...
public static class Settings
{
    ...
    private const string sincronizacionCompleta = "SincronizacionCompleta";
    ...
    public static bool SincronizacionCompleta
    {
        get
        {
            return AppSettings.GetValueOrDefault(sincronizacionCompleta, booleanDefault);
        }
        set
        {
            AppSettings.AddOrUpdateValue(sincronizacionCompleta, value);
        }
    }
